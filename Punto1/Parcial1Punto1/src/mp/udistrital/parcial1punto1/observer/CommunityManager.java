 ...
 * @author Estudiantes
 */
public class CommunityManager implements Suscriptor {
    private String nombre;
    private String identificacion;
    private Curso cursoActual;
    private Publicador edco;
    
    public CommunityManager(String nombre, String identificacion, Publicador edco) {
        this.nombre = nombre;
    ...
    public void darseDeBaja() {
        ...
        System.out.println("Community Manager " + nombre + " se ha dado de baja de EDCO.");
    }
